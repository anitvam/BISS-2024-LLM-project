...
As described in \Cref{sec:dataset-description},
the dataset comes in a CSV and Pandas~\cite{reback2020pandas} was used to build a DataFrame from it,
and manipulate the data.

Preliminary,
a data exploration over the dataset is performed to understand the categorical labels' distribution,
