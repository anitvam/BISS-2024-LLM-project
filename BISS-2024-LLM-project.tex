...
determining the proliferation of conspiracies theories in many contexts like COVID, war in Ukraine,
diffusing dangerous ideas generating social harm.
%
In this paper we present the training process for fine-tune two \acp{llm} architectures
